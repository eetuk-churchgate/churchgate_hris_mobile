...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
        ...
        builder: (ctx, setDialogState) {
          return AlertDialog(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected = selectedMembers.any((m) => m['id'] == empId);
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: selectedMembers.isEmpty || nameController.text.trim().isEmpty
                    ? null
                    : () async {
                        Navigator.pop(ctx);
  ...
  Widget _buildChatHeader() {
    ...
    final name = isGroup
        ? _activeConversation!['name'] ?? 'Group'
        : _participants
              .firstWhere(
                (p) => p['employee_id'] != widget.user['employee_id'],
                orElse: () => {'employee_name': 'Unknown'},
              )['employee_name'] ?? 'Unknown';

    final otherEmpId = isGroup
        ? null
        : _participants
              .firstWhere(
                (p) => p['employee_id'] != widget.user['employee_id'],
                orElse: () => {'employee_id': null},
              )['employee_id'];

    final isOnline = otherEmpId != null && _onlineUsers.any((u) => u['employee_id'] == otherEmpId);

    return GestureDetector(
      onTap: () => setState(() => _activeConversation = null),
      child: Row(
        children: [
          Stack(
            children: [
          ...
          Column(
            ...
            children: [
              ...
              if (_typingUsers.containsKey(_activeConversation!['id']))
                Text('${_typingUsers[_activeConversation!['id']]} typing...',
  ...
  Widget _buildConversationTile(Map<String, dynamic> conv) {
    ...
    final time = conv['last_message_at'] != null
        ? DateFormat('HH:mm').format(DateTime.parse(conv['last_message_at'].toString()))
        : '';
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    DateFormat('HH:mm').format(DateTime.parse(msg['sent_at'].toString())),
                  ...
                  if (isMe) ...[
                    ...
                    Icon(
                      ...
                      size: 14,
                      color: msg['is_read'] == true ? Colors.blue : Colors.white54,
                    ),
                  ],
                ],
              ),
      ...
      child: Column(
        children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text('Replying to $_replyingToSender', style: const TextStyle(fontSize: 12))),
                  GestureDetector(
                    onTap: () => setState(() { _replyingTo = null; _replyingToSender = null; }),
          ...
          Row(
            children: [
              IconButton(
                icon: Icon(_showEmojiPicker ? Icons.keyboard : Icons.emoji_emotions, color: const Color(0xFFD4AF37)),
            ...
            onChanged: (val) {
              setState(() {
                if (val.isEmpty) {
                  ...
                  _searchResults = _allEmployees.where((e) {
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final empId = emp['employee_id']?.toString() ?? '';
              final isOnline = _onlineUsers.any((u) => u['employee_id'] == empId);
              return ListTile(
                leading: Stack(
                  children: [
                    CircleAvatar(
